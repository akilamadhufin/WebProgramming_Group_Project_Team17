...
<html lang="en">
  ...
  <body>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <div class="d-flex" style="justify-content: flex-end;">
              ...
              $select_rows = mysqli_query($conn, "SELECT * FROM `cart` where email='$userEmail'") or die('query failed');
              $row_count = mysqli_num_rows($select_rows);
              ?>
                    <a style="color:white; font-size: 16px;" href="cart.php" class="btn btn-brand position-relative me-3">cart <span><?php echo $row_count; ?></span></a>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-rHyoN1iRsVXV4nDQFkkwzsM6pxLlO/uI+q6LwlvS6sf4Ehq/6U6QeA6MclLOE+5t" crossorigin="anonymous"></script>
