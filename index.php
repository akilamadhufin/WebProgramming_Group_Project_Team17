          ...
          <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" class="row justify-content-center" name="addReservation" id="addReservation" method="post">
            <div class="col-lg-8">
              <div class="row g-3">
                ...
                <div class="form-group col-md-6">
                  <input type="email" class="form-control" placeholder="Email Address" id="email" name="email" required oninput="validateemail()">
                ...
                <div class="form-group col-md-6">
                  <input type="number" class="form-control" placeholder="Number of Persons" id="numOfPersons" name="numOfPersons" required>
                </div>
        ...
        <?php
          ...
          if(isset($_POST['addReservation'])){
            ...
            if($conn->query($submitreservationsql)===TRUE){
              ...
              echo "<script>window.alert('Error in submitting: use the same email address used to login "  . "');</script>";
            }
