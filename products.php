...
if(isset($_POST['add_to_cart'])){
   ...
   if(mysqli_num_rows($select_cart) > 0){
      ...
      $insert_product = mysqli_query($conn, "INSERT INTO `cart`(name, price, category, rating, description, image, quantity) VALUES('$product_name', '$product_price', '$product_category','$product_rating', '$product_description', '$product_image', '$product_quantity')");
